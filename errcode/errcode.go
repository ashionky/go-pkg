...
var CaptchaNotFound = &apiErrorImp{1011, "未找到验证码"}
var CaptchaExpired = &apiErrorImp{1012, "验证码已过期"}
var CaptchaWrong = &apiErrorImp{1013, "验证码错误"}
var RecordNotFound = &apiErrorImp{1014, "记录未找到"}
