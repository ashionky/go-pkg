...
type ReportEvent struct {
	...
	Time      string                 `json:"time" bson:"time"`           //事件时间，
	Body      map[string]interface{} `json:"body" bson:"body"`           //事件内容
	RetryTime string                 `json:"retryTime" bson:"retryTime"` //重试时间
	Num       int32                  `json:"num" bson:"num"`             //重试次数
}
